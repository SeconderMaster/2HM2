...
import com.example.lmj.a2hm2.Community.bbb_Community;
...
public class MainActivity extends FragmentActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    private static TextView ic_myhome;
    private static TextView ic_community;
    private static TextView ic_release;
    private static TextView ic_msg;
    private static TextView ic_my;
    ...
    public static void TabSelection(int number){
    ...
    private void initView() {
        ...
        fragmentList.add(new bbb_Community());
