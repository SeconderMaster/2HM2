...
public class bb_My extends Fragment implements View.OnClickListener {
    ...
    private void initView() {
        ...
        user_name.setText((String)BmobUser.getObjectByKey("username"));
        user_sign.setText((String)BmobUser.getObjectByKey("userSign"));
...
//                else {
//                    startActivity(new Intent(getActivity(),My_Data.class));
//                }
                break;
            case R.id.login_now:
                if (!isLogin.isLogin()){
